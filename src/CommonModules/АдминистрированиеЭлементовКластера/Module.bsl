...
Функция ПолучитьСписокНовыхКонфигураций() Экспорт
	...
	МассивФайловШаблонов = НайтиФайлы(КаталогШаблоновКонфигураций, "*.mft", Истина);
	...
	Для Каждого НайденыйФайл Из МассивФайловШаблонов Цикл
	...
	Пока Выборка.Следующий() Цикл
		...
		СписокНовыхКонфигураций.	Добавить(СтруктураОписанияКонфигурации, СтруктураОписанияКонфигурации.Синоним);
...
Функция ПолучитьСтруктуруМанифестаКонфигурации(ПутьКФайлу)
	...
	СтруктураОписанияКонфигурации.Вставить("МассивФайлов");
	...
	Пока СтрокаФайла <> Неопределено Цикл
	    ...
	    ИначеЕсли Лев(Параметр, 1) = "[" Тогда
			...
			Если СтруктураСекции <> Неопределено Тогда
				МассивФайлов.Добавить(СтруктураСекции);
			Иначе
				СтруктураСекции = Новый Структура;
			КонецЕсли;
			
			Секция = Сред(Параметр, 1, Параметр - 1);
	    ...
	    ИначеЕсли Сред(Параметр, 7) = "Catalog" Тогда
	    		СтруктураСекции.	ИмяКаталога = Значение;	
	...
	СтруктураОписанияКонфигурации.МассивФайлов = МассивФайлов;
