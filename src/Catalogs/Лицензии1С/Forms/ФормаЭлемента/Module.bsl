...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьДействияЭлементовКопированиеВБуфер();
	
КонецПроцедуры

&НаСервере
Процедура УстановитьДействияЭлементовКопированиеВБуфер()
	
	МассивИменЭлементов = Новый Массив();
	
	МассивИменЭлементов.Добавить("Организация");
	МассивИменЭлементов.Добавить("Фамилия");
	МассивИменЭлементов.Добавить("Имя");
	МассивИменЭлементов.Добавить("Отчество");
	МассивИменЭлементов.Добавить("АдресЭлПочты");
	МассивИменЭлементов.Добавить("Страна");
	МассивИменЭлементов.Добавить("Область");
	МассивИменЭлементов.Добавить("Индекс");
	МассивИменЭлементов.Добавить("Район");
	МассивИменЭлементов.Добавить("Город");
	МассивИменЭлементов.Добавить("Улица");
	МассивИменЭлементов.Добавить("Дом");
	МассивИменЭлементов.Добавить("Корпус");
	МассивИменЭлементов.Добавить("Квартира");
	
	Для Каждого ЭлементМассива Из МассивИменЭлементов Цикл
		Элементы[ЭлементМассива].УстановитьДействие("НачалоВыбора", "РеквизитРегистрационныхДанныхНачалоВыбора");
	КонецЦикла;
