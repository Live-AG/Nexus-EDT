...
Процедура ПолучитьДанныеАдминистрированиеСервера(Отказ)
	...
	АгентАдминистрирования = АдминистрированиеЭлементовКластера.ПолучитьАгентаАдминистрированияКластера(СтруктураПараметров, Отказ);
...
Процедура ПодключитьсяККластеру(Команда)
	...
	ЗаполнитьЭлементыКластера();	
	Элементы.СтраницыШагов.ТекущаяСтраница = Элементы.СтраницаИнформационныхБаз;				
	
КонецПроцедуры  

&НаСервере
Процедура ЗаполнитьЭлементыКластера()
	
	ЗаполнитьСписокБаз();
	ЗаполнитьСписокРабочихСерверов();	
...
&НаСервере
Процедура ЗаполнитьСписокРабочихСерверов()
